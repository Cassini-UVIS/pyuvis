...
get_ipython().magic('load ../pyuvis/readers.py')
...
def read_idlsav_file(file):
    ...
    for thiskey in tmp.keys():
        try:
            ...
            print("Item with key {} has no length. Skipping.".format(thiskey))
            continue
...
fname = '/Users/maye/data/uvis/EUV2010_05_18_05_51_44_UVIS_131SU_ICYSUNOCC001_PRIME_LTS.sav'
